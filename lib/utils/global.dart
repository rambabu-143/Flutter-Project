...
String baseUrl = "https://123astro.live/api";
String imgBaseurl = "https://123astro.live/";
String webBaseUrl = "https://123astro.live/api/";
String appMode = "LIVE";
Map<String, dynamic> appParameters = {
  "LIVE": {
    "apiUrl": "https://123astro.live/api",
    "imageBaseurl": "https://123astro.live/",
  },
  "DEV": {
    "apiUrl": "https://123astro.live/api",
    "imageBaseurl": "https://123astro.live/",
...
String agoraToken = "";
String channelName = "astrotera";
String agoraLiveToken = "";
String liveChannelName = "astrotera";
String agoraChatUserId = "astrotera";
String chatChannelName = "astrotera";
...
Future<void> callOnFcmApiSendPushNotifications({
  ...
  try {
    ...
    final url = Uri.parse(
        'https://fcm.googleapis.com/v1/projects/astro-b1969/messages:send');
